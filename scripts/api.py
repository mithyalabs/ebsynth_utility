...
def ebsynth_utility_api(_:gr.Blocks, app: FastAPI):
    ...
    async def ebsynth_process(
        ...
        key_min_gap:int = Body(default=None),
        key_max_gap:int = Body(default=None), 
        key_th:float = Body(default=None),
        key_add_last_frame:bool  = Body(default=None) , 
        color_matcher_method:str  = Body(default=None),
        st3_5_use_mask:bool =  Body(default=None), 
        st3_5_use_mask_ref:bool  = Body(default=None), 
        st3_5_use_mask_org:bool  = Body(default=None), 
        color_matcher_ref_type:int  = Body(default=None),
        color_matcher_ref_image:str = Body(default=None), 
        blend_rate:float = Body(default=None), 
        export_type:str = Body(default=None), 
        bg_src:str = Body(default=None),
        bg_type:str = Body(default=None), 
        mask_blur_size:int  = Body(default=None), 
        mask_threshold:float  = Body(default=None), 
        fg_transparency:float  = Body(default=None),
        mask_mode:str  = Body(default=None)
    ):
